...
class List_Table_Server extends WP_List_Table {
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            'dstime'       => array('dstime', false),
            'tcptime'      => array('tcptime', false),
            'filestime'    => array('filestime', false),
            'bytetime'     => array('bytetime', false),
            'totaltime'    => array('totaltime', false),
    ...
    function prepare_items() {
        ...
        $query = "SELECT * FROM $wpdb->prefix" . "gtmetrix_log_server" ;
